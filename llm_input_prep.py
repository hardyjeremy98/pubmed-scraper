...
class FigureTextExtractor:
    """
    Legacy class for backward compatibility. Use extract_figure_text function instead.
    """

    def __init__(self, context_words: int = 250, include_surrounding_text: bool = True):
        """
        ...
        self.include_surrounding_text = include_surrounding_text
    ...
    def extract_figure_context(
        ...
        """
        return extract_figure_text(
            article_text=article_text,
            figure_number=figure_number,
            figure_data=figure_data,
            pmid=pmid,
            base_dir=base_dir,
            include_surrounding_text=self.include_surrounding_text,
